# nvim-treesitter-queries-dockerfile

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-dockerfile/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-dockerfile/actions/workflows/validate.yml)

Neovim tree-sitter queries for **dockerfile**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-dockerfile",
...
- [ ] Changes are scoped to `dockerfile` — do not include files for other languages
